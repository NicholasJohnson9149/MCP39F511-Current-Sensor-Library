/* LM75A library by Quentin Comte-Gaz
 *
 ...
 * \version 1.1
 * 
 * \available at: https://github.com/QuentinCG/Arduino-LM75A-Temperature-Sensor-Library
 * \imported by: Saulo Aflitos
 * \import date: 13 March 2018
 * 
 */
...
float LM75A::getTemperatureInDegrees() const
{
  ...
  if (Wire.requestFrom(_i2c_device_address, 2)) {
    ...
    Wire.readBytes((char*)&i2c_received, 2);
  } else {
